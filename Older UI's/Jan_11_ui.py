...
def show_extraction_details(file_menu):
   ...
   details_menu.geometry('2000x900') #widthxheight 
 ...
 #   details_menu.bind("<Enter>", lambda e: exit_program(details_menu))
   ...
   tk.Label(text="Extraction Breakdown", bg='light green', font=("Georgia bold", 18), fg=black).grid(row=1, column=3, sticky=tk.W+tk.E+tk.N+tk.S)

   tk.Label(text=" | ", bg='light green', font=("calibri bold", 15), fg='light green').grid(row=0, column=0, sticky=tk.W+tk.E+tk.N+tk.S) # leftmost padding
   tk.Label(text="Reason", bg='light green', font=("calibri bold", 15), fg=black, relief = 'sunken').grid(row=4, column=1, sticky=tk.W+tk.E+tk.N+tk.S)
   tk.Label(text=" | ", bg='light green', font=("Georgia bold", 15), fg='light green').grid(row=4, column=2, sticky=tk.W+tk.E+tk.N+tk.S)
   
   tk.Label(text="Dialogue", bg='light green', font=("Georgia bold", 15), fg=black, relief = 'sunken').grid(row=4, column=3, sticky=tk.W+tk.E+tk.N+tk.S)
   tk.Label(text=" | ", bg='light green', font=("Georgia bold", 15), fg='light green').grid(row=4, column=4, sticky=tk.W+tk.E+tk.N+tk.S)
   
   tk.Label(text="Speaker", bg='light green', font=("Georgia bold", 15), fg=black, relief = 'sunken').grid(row=4, column=5, sticky=tk.W+tk.E+tk.N+tk.S)
   tk.Label(text=" | ", bg='light green', font=("Georgia bold", 15), fg='light green').grid(row=0, column=6, sticky=tk.W+tk.E+tk.N+tk.S)

   tk.Label(text="Context", bg='light green', font=("Georgia bold", 15), fg=black, relief = 'sunken').grid(row=4, column=7, sticky=tk.W+tk.E+tk.N+tk.S)
   tk.Label(text=" | ", bg='light green', font=("Georgia bold", 15), fg='light green').grid(row=4, column=8, sticky=tk.W+tk.E+tk.N+tk.S)
   
   
   tk.Label(text=" | ", bg='light green', font=("Georgia bold", 15), fg='light green').grid(row=3, column=1, sticky=tk.W+tk.E+tk.N+tk.S)
   
   tk.Label(text=" | ", bg='light green', font=("Georgia bold", 15), fg='light green').grid(row=5, column=0, sticky=tk.W+tk.E+tk.N+tk.S)
   ...
   tk.Label(text=" ", bg='light green', font=("Georgia", 10), fg=black).grid(row=2, column=9, sticky=tk.W+tk.E+tk.N+tk.S)   
   ...
   tk.Label(text=" | ", bg='light green', font=("Georgia", 10), fg='light green').grid(row=2, column=2, sticky=tk.W+tk.E+tk.N+tk.S)   

   ttk.Button(text="Create an audiobook", command=lambda: open_Audio_real(details_menu, textfield, characters)).grid(row=2, column=3, columnspan=1, sticky=tk.W+tk.E+tk.N+tk.S)

   tk.Label(text=" | ", bg='light green', font=("Georgia", 10), fg='light green').grid(row=2, column=4, sticky=tk.W+tk.E+tk.N+tk.S)   

   ttk.Button(text="View the full text", command=lambda: view_full_text(details_menu, text_array)).grid(row=2, column=5, columnspan=1, sticky=tk.W+tk.E+tk.N+tk.S)
   
   tk.Label(text=" | ", bg='light green', font=("Georgia", 10), fg='light green').grid(row=2, column=6, sticky=tk.W+tk.E+tk.N+tk.S)   

   
   ttk.Button(text="Exit the program", command=lambda: exit_program(details_menu)).grid(row=2, column=7, columnspan=1, sticky=tk.W+tk.E+tk.N+tk.S)
...
def find_speaker(line, dialogue_closing_index, characters): # make an array of all the speakers of the text
   ...
   for verb in verb_array:
      if verb in line:
         ...
         if speaker == 0: speaker = verb_directly_before_speaker(line, verb, dialogue_closing_index, characters)
         if speaker == 0: speaker, characters = speaker_not_in_characters(line, verb, dialogue_closing_index, characters)            
         
   f.close()   

   return speaker, characters

def speaker_not_in_characters(line, verb, dialogue_closing_index, characters):
