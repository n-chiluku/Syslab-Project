...
def show_extraction_details(file_menu):
  ...
  #  tk.Label(text=" | ", bg='light green', font=("Georgia bold", 15), fg=black).grid(row=0, column=7, sticky=tk.W+tk.E+tk.N+tk.S)
 ...
 #   tk.Label(text="", font=("Georgia", 10), fg=grey).grid(row=0, column=3, sticky=tk.W+tk.E+tk.N+tk.S)
   # rowCounter = 2
#    if len(text_array) < 10:
  
  #  for index in range(0, len(text_array)): #show excerpt 
#    #    print("txt arr", text_array[index])
#       tk.Label(text=text_array[index], font=("Georgia", 10), fg=grey).grid(row=rowCounter, column=3, sticky=tk.W+tk.E+tk.N+tk.S)
# #       tk.Label(text="", font=("Georgia", 10), fg=grey).grid(row=index+1, column=3, sticky=tk.W+tk.E+tk.N+tk.S)
#       rowCounter+=1
#    else:
#       tk.Label(text="Excerpt of text", font=("Georgia", 10), fg=grey).grid(row=0, column=4, sticky=tk.W+tk.E+tk.N+tk.S)
#       for index in range(0, 10): #show excerpt 
#          tk.Label(text=text_array[index], font=("Georgia", 10), fg=grey).grid(row=index+1, column=4, sticky=tk.W+tk.E+tk.N+tk.S)
         
   tk.Label(text=" ", bg='light green', font=("Georgia", 10), fg=black).grid(row=1, column=8, sticky=tk.W+tk.E+tk.N+tk.S)   
   
   
   playsound('C:/Users/1504522/Desktop/Syslab Project/Audiobooks/AndrewNeil.mp3')
  ...
  #  open_button3 = ttk.Button(file_menu, text='Open a File',command=select_file)
