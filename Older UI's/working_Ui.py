...
def show_extraction_details(file_menu):
 ...
 #   details_menu.bind("<Enter>", lambda e: exit_program(details_menu))
   ...
   tk.Label(text="Reason", bg='light green', font=("Georgia bold", 15), fg=black, relief = 'sunken').grid(row=3, column=1, sticky=tk.W+tk.E+tk.N+tk.S)
   tk.Label(text=" | ", bg='light green', font=("Georgia bold", 15), fg='light green').grid(row=3, column=2, sticky=tk.W+tk.E+tk.N+tk.S)
   
   tk.Label(text="Dialogue", bg='light green', font=("Georgia bold", 15), fg=black, relief = 'sunken').grid(row=3, column=3, sticky=tk.W+tk.E+tk.N+tk.S)
   tk.Label(text=" | ", bg='light green', font=("Georgia bold", 15), fg='light green').grid(row=3, column=4, sticky=tk.W+tk.E+tk.N+tk.S)
   
   tk.Label(text="Speaker", bg='light green', font=("Georgia bold", 15), fg=black, relief = 'sunken').grid(row=3, column=5, sticky=tk.W+tk.E+tk.N+tk.S)
   tk.Label(text=" | ", bg='light green', font=("Georgia bold", 15), fg='light green').grid(row=0, column=6, sticky=tk.W+tk.E+tk.N+tk.S)

   tk.Label(text="Context", bg='light green', font=("Georgia bold", 15), fg=black, relief = 'sunken').grid(row=3, column=7, sticky=tk.W+tk.E+tk.N+tk.S)
   tk.Label(text=" | ", bg='light green', font=("Georgia bold", 15), fg='light green').grid(row=3, column=8, sticky=tk.W+tk.E+tk.N+tk.S)
 ...
 #   tk.Label(text="Excerpt of text", bg='light green', font=("Georgia bold", 15), fg=black).grid(row=1, column=7, sticky=tk.W+tk.E+tk.N+tk.S)
   ...
   tk.Label(text=" | ", bg='light green', font=("Georgia bold", 15), fg='light green').grid(row=2, column=1, sticky=tk.W+tk.E+tk.N+tk.S)
   ...
   tk.Label(text=" | ", bg='light green', font=("Georgia", 10), fg='light green').grid(row=1, column=2, sticky=tk.W+tk.E+tk.N+tk.S)   

   ttk.Button(text="Create an audiobook", command=lambda: open_Audio_real(details_menu, textfield, characters)).grid(row=1, column=3, columnspan=1, sticky=tk.W+tk.E+tk.N+tk.S)

   tk.Label(text=" | ", bg='light green', font=("Georgia", 10), fg='light green').grid(row=1, column=4, sticky=tk.W+tk.E+tk.N+tk.S)   

   ttk.Button(text="View the full text", command=lambda: view_full_text(details_menu, text_array)).grid(row=1, column=5, columnspan=1, sticky=tk.W+tk.E+tk.N+tk.S)
   
   tk.Label(text=" | ", bg='light green', font=("Georgia", 10), fg='light green').grid(row=1, column=6, sticky=tk.W+tk.E+tk.N+tk.S)   

   
   ttk.Button(text="Exit the program", command=lambda: exit_program(details_menu)).grid(row=1, column=7, columnspan=1, sticky=tk.W+tk.E+tk.N+tk.S)
